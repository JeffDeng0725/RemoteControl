...
//CTango::CTango(LPCSTR szDirectory/*=0*/)	// Zugriff auf die DLL von verschiedenen Dateipfaden aus ermöglichen
CTango::CTango(){
        ...
        m_pSetControllerFactorSingleAxis=NULL;
        m_pGetControllerFactorSingleAxis=NULL;
        m_pSetControllerTWDelay=NULL;
        m_pSetControllerTWDelaySingleAxis=NULL;
        ...
        m_pGetEncoderSingleAxis=NULL;
        m_pSetEncoderSingleAxis=NULL;
        ...
        m_pGetControllerTWDelaySingleAxis=NULL;
		...
		m_pSetBlSmoothSingleAxis=NULL;
		m_pGetBlSmoothSingleAxis=NULL;
...
*/
        ...
        else
        {
                ...
                VERIFY(m_pSetSecVel= (PSetSecVel) GetProcAddress(m_Tango,"LSX_SetSecVel"));
                if (!m_pSetSecVel) m_DLLResultat=-2;
                ...
                VERIFY(m_pClearProtocolWindow= (PClearProtocolWindow) GetProcAddress(m_Tango,"LSX_ClearProtocolWindow"));
                if (!m_pClearProtocolWindow) m_DLLResultat=-2;
                ...
                VERIFY(m_pGetAuxDigitalInput= (PGetAuxDigitalInput) GetProcAddress(m_Tango,"LSX_GetAuxDigitalInput"));
                if (!m_pGetAuxDigitalInput) m_DLLResultat=-2;
                ...
                VERIFY(m_pSetDigitalOutputE= (PSetDigitalOutputE) GetProcAddress(m_Tango,"LSX_SetDigitalOutputE"));
                if (!m_pSetDigitalOutputE) m_DLLResultat=-2;
                ...
                VERIFY(m_pSetAnalogOutputMode= (PSetAnalogOutputMode) GetProcAddress(m_Tango,"LSX_SetAnalogOutputMode"));
                if (!m_pSetAnalogOutputMode) m_DLLResultat=-2;

                VERIFY(m_pGetAnalogOutputMode= (PGetAnalogOutputMode) GetProcAddress(m_Tango,"LSX_GetAnalogOutputMode"));
                if (!m_pGetAnalogOutputMode) m_DLLResultat=-2;
                ...
                VERIFY(m_pSetSecVelSingleAxis= (PSetSecVelSingleAxis) GetProcAddress(m_Tango,"LSX_SetSecVelSingleAxis"));
                if (!m_pSetSecVelSingleAxis) m_DLLResultat=-2;
                ...
                VERIFY(m_pGetAutoStatus= (PGetAutoStatus) GetProcAddress(m_Tango,"LSX_GetAutoStatus"));
                if (!m_pGetAutoStatus) m_DLLResultat=-2;

                VERIFY(m_pGetStatusAxis= (PGetStatusAxis) GetProcAddress(m_Tango,"LSX_GetStatusAxis"));
                if (!m_pGetStatusAxis) m_DLLResultat=-2;

                VERIFY(m_pGetStA= (PGetStA) GetProcAddress(m_Tango,"LSX_GetStA"));
                if (!m_pGetStA) m_DLLResultat=-2;
                ...
                VERIFY(m_pSetControllerFactorSingleAxis= (PSetControllerFactorSingleAxis) GetProcAddress(m_Tango,"LSX_SetControllerFactorSingleAxis"));
                if (!m_pSetControllerFactorSingleAxis) m_DLLResultat=-2;
                ...
                VERIFY(m_pSetControllerTWDelaySingleAxis= (PSetControllerTWDelaySingleAxis) GetProcAddress(m_Tango,"LSX_SetControllerTWDelaySingleAxis"));
                if (!m_pSetControllerTWDelaySingleAxis) m_DLLResultat=-2;
                ...
                VERIFY(m_pGetErrorString= (PGetErrorString) GetProcAddress(m_Tango,"LSX_GetErrorString"));
                if (!m_pGetErrorString) m_DLLResultat=-2;
                ...
                VERIFY(m_pGetCommandTimeout= (PGetCommandTimeout) GetProcAddress(m_Tango,"LSX_GetCommandTimeout"));
                if (!m_pGetCommandTimeout) m_DLLResultat=-2;
                ...
                VERIFY(m_pGetSecVel= (PGetSecVel) GetProcAddress(m_Tango,"LSX_GetSecVel"));
                if (!m_pGetSecVel) m_DLLResultat=-2;
                ...
                VERIFY(m_pGetEncoderSingleAxis= (PGetEncoderSingleAxis) GetProcAddress(m_Tango,"LSX_GetEncoderSingleAxis"));
                if (!m_pGetEncoderSingleAxis) m_DLLResultat=-2;

                VERIFY(m_pSetEncoderSingleAxis= (PSetEncoderSingleAxis) GetProcAddress(m_Tango,"LSX_SetEncoderSingleAxis"));
                if (!m_pSetEncoderSingleAxis) m_DLLResultat=-2;
                ...
                VERIFY(m_pGetControllerFactorSingleAxis= (PGetControllerFactorSingleAxis) GetProcAddress(m_Tango,"LSX_GetControllerFactorSingleAxis"));
                if (!m_pGetControllerFactorSingleAxis) m_DLLResultat=-2;
                ...
                VERIFY(m_pGetControllerTWDelaySingleAxis= (PGetControllerTWDelaySingleAxis) GetProcAddress(m_Tango,"LSX_GetControllerTWDelaySingleAxis"));
                if (!m_pGetControllerTWDelaySingleAxis) m_DLLResultat=-2;
                ...
                VERIFY(m_pGetBlSmoothSingleAxis= (PGetBlSmoothSingleAxis) GetProcAddress(m_Tango,"LSX_GetBlSmoothSingleAxis"));
                if (!m_pGetBlSmoothSingleAxis) m_DLLResultat=-2;

                VERIFY(m_pSetBlSmoothSingleAxis= (PSetBlSmoothSingleAxis) GetProcAddress(m_Tango,"LSX_SetBlSmoothSingleAxis"));
                if (!m_pSetBlSmoothSingleAxis) m_DLLResultat=-2;
                ...
                VERIFY(m_pGetTray= (PGetTray) GetProcAddress(m_Tango,"LSX_GetTray"));
                if (!m_pGetTray) m_DLLResultat=-2;

                VERIFY(m_pPutTray= (PPutTray) GetProcAddress(m_Tango,"LSX_PutTray"));
                if (!m_pPutTray) m_DLLResultat=-2;
...
//                if (!m_pGetNumberOfMagazines) m_DLLResultat=-2;
                ...
                VERIFY(m_pGetNumberOfSlots= (PGetNumberOfSlots) GetProcAddress(m_Tango,"LSX_GetNumberOfSlots"));
                if (!m_pGetNumberOfSlots) m_DLLResultat=-2;
...
int CTango::ConnectSimple (int lAnInterfaceType, char *pcAComName, int lABaudRate, int lAShowProt)
{
/*   int HelpID;
...
*/
	if (m_pConnectSimple)
        {
                return m_pConnectSimple (m_LSID, lAnInterfaceType, pcAComName, lABaudRate, lAShowProt);
        }
        else
                return -1;
}
...
int CTango::SetSecVel (double dX, double dY, double dZ, double dA)
{
        if (m_pSetSecVel)
        {
                return m_pSetSecVel (m_LSID, dX, dY, dZ, dA);
        }
        else
                return -1;
}
...
int CTango::ClearProtocolWindow ()
{
        if (m_pClearProtocolWindow)
        {
                return m_pClearProtocolWindow (m_LSID);
        }
        else
                return -1;
}
...
int CTango::GetAuxDigitalInput (int lIndex, BOOL *bValue)
{
        if (m_pGetAuxDigitalInput)
        {
                return m_pGetAuxDigitalInput (m_LSID, lIndex, bValue);
        }
        else
                return -1;
}
...
int CTango::SetDigitalOutputE (int lIndex, BOOL bValue)
{
        if (m_pSetDigitalOutputE)
        {
                return m_pSetDigitalOutputE (m_LSID, lIndex, bValue);
        }
        else
                return -1;
}
...
int CTango::SetAnalogOutputMode(int lIndex, int lValue)
{
        if (m_pSetAnalogOutputMode)
        {
                return m_pSetAnalogOutputMode (m_LSID, lValue);
        }
        else
                return -1;
}

int CTango::GetAnalogOutputMode(int lIndex, int *plValue)
{
        if (m_pGetAnalogOutputMode)
        {
                return m_pGetAnalogOutputMode (m_LSID, plValue);
        }
        else
                return -1;
}
...
int CTango::SetSecVelSingleAxis (int lAxis, double dVel)
{
        if (m_pSetSecVelSingleAxis)
        {
                return m_pSetSecVelSingleAxis (m_LSID, lAxis, dVel);
        }
        else
                return -1;
}
...
int CTango::SetShowProt (int lShowProt)
{
        if (m_pSetShowProt)
        {
                return m_pSetShowProt (m_LSID, lShowProt);
        }
        else
                return -1;
}
...
int CTango::GetAutoStatus (int *plValue)
{
        if (m_pGetAutoStatus)
        {
                return m_pGetAutoStatus (m_LSID, plValue);
        }
        else
                return -1;
}
...
int CTango::GetStA (int *plStaX, int *plStaY, int *plStaZ, int *plStaA)
{
        if (m_pGetStA)
        {
                return m_pGetStA (m_LSID, plStaX, plStaY, plStaZ, plStaA);
        }
        else
                return -1;
}
...
int CTango::SetControllerFactorSingleAxis (int lAxis, double dFactor1, double dFactor2)
{
        if (m_pSetControllerFactorSingleAxis)
        {
                return m_pSetControllerFactorSingleAxis (m_LSID, lAxis, dFactor1, dFactor2);
        }
        else
                return -1;
}
...
int CTango::SetControllerTWDelaySingleAxis (int lAxis, int lCtrTWDelay)
{
        if (m_pSetControllerTWDelaySingleAxis)
        {
                return m_pSetControllerTWDelaySingleAxis (m_LSID, lAxis, lCtrTWDelay);
        }
        else
                return -1;
}
...
int CTango::GetErrorString (int lErrorCode, char *pcErrorString, int lMaxLen)
{
        if (m_pGetErrorString)
        {
                return m_pGetErrorString (m_LSID, lErrorCode, pcErrorString, lMaxLen);
        }
        else
                return -1;
}
...
int CTango::GetCommandTimeout (int *plAtoRead, int *plAtoMove, int *plAtoCalibrate)
{
        if (m_pGetCommandTimeout)
        {
                return m_pGetCommandTimeout (m_LSID, plAtoRead, plAtoMove, plAtoCalibrate);
        }
        else
                return -1;
}
...
int CTango::GetSecVel (double *pdX, double *pdY, double *pdZ, double *pdA)
{
        if (m_pGetSecVel)
        {
                return m_pGetSecVel (m_LSID, pdX, pdY, pdZ, pdA);
        }
        else
                return -1;
}
...
int CTango::GetEncoderSingleAxis (int lAxis, int *plEncoderType, double *pdPeriod, int *plRef)
{
        if (m_pGetEncoderSingleAxis)
        {
                return m_pGetEncoderSingleAxis (m_LSID, lAxis, plEncoderType, pdPeriod, plRef);
        }
        else
                return -1;
}

int CTango::SetEncoderSingleAxis (int lAxis, int lEncoderType, double dPeriod, int lRef)
{
        if (m_pSetEncoderSingleAxis )
        {
                return m_pSetEncoderSingleAxis  (m_LSID, lAxis, lEncoderType, dPeriod, lRef);
        }
        else
                return -1;
}
...
int CTango::GetControllerFactorSingleAxis (int lAxis, double *pdFactor1, double *pdFactor2)
{
        if (m_pGetControllerFactorSingleAxis)
        {
                return m_pGetControllerFactorSingleAxis (m_LSID, lAxis, pdFactor1, pdFactor2);
        }
        else
                return -1;
}
...
int CTango::GetControllerTWDelaySingleAxis (int lAxis, int *plCtrTWDelay)
{
        if (m_pGetControllerTWDelaySingleAxis)
        {
                return m_pGetControllerTWDelaySingleAxis (m_LSID, lAxis, plCtrTWDelay);
        }
        else
                return -1;
}
...
int CTango::SetBlSmoothSingleAxis (int lAxis, int lBlSmooth)
{
        if (m_pSetBlSmoothSingleAxis)
        {
                return m_pSetBlSmoothSingleAxis (m_LSID, lAxis, lBlSmooth);
        }
        else
                return -1;
}

int CTango::GetBlSmoothSingleAxis (int lAxis, int *plBlSmooth)
{
        if (m_pGetBlSmoothSingleAxis)
        {
                return m_pGetBlSmoothSingleAxis (m_LSID, lAxis, plBlSmooth);
        }
        else
                return -1;
}
...
int CTango::GetTray (int slot, int mode)
{
        if (m_pGetTray)
        {
                return m_pGetTray (m_LSID, slot, mode);
        }
        else
                return -1;
}

int CTango::PutTray (int slot)
{
        if (m_pPutTray)
        {
                return m_pPutTray (m_LSID, slot);
        }
        else
                return -1;
}
...
int CTango::GetNumberOfSlots (int *pNumberOfSlots)
{
        if (m_pGetNumberOfSlots)
        {
                return m_pGetNumberOfSlots (m_LSID, pNumberOfSlots);
        }
        else
                return -1;
}
...
int CTango::SetResolution (int lRes)
{
        if (m_pSetResolution)
        {
                return m_pSetResolution (m_LSID, lRes);
        }
        else
                return -1;
}

int CTango::GetResolution (int *plRes)
{
        if (m_pGetResolution)
        {
                return m_pGetResolution (m_LSID, plRes);
        }
        else
                return -1;
}
