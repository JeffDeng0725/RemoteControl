...
TANGOAPI int TANGOCALL LSX_ConnectSimple (int lLSID, int lAnInterfaceType, char *pcAComName, int lABaudRate, int lAShowProt);
...
TANGOAPI int TANGOCALL LSX_SetShowProt (int lLSID, int lShowProt);
