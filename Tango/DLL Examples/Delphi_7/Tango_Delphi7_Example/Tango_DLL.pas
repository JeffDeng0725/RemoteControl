...
function LSX_ConnectSimple(LSID: Integer; AnInterfaceType: Integer; AComName: PChar; ABaudRate: Integer; AShowProt: LongBool): Integer; stdcall; external TangoDLL;
...
function LSX_LoadConfig(LSID: Integer; FileName: PChar): Integer; stdcall; external TangoDLL;
function LSX_SaveConfig(LSID: Integer; FileName: PChar): Integer; stdcall; external TangoDLL;
...
function LSX_GetStatus(LSID: Integer; Stat: PChar; MaxLen: Integer): Integer; stdcall; external TangoDLL;
...
function LSX_SendString(LSID: Integer; Str, Ret: PChar; MaxLen: Integer; ReadLine: LongBool; TimeOut: Integer): Integer; stdcall; external TangoDLL;
...
function LSX_GetStatusAxis(LSID: Integer; StatusAxisStr: PChar; MaxLen: Integer): Integer; stdcall; external TangoDLL;
...
function LSX_GetVersionStr(LSID: Integer; Vers: PChar; MaxLen: Integer): Integer; stdcall; external TangoDLL;
...
function LSX_SetCorrTblOn(LSID: Integer; AFileName: PChar): Integer; stdcall; external TangoDLL;
...
function LSX_SetLanguage(LSID: Integer; PLN: PChar): Integer; stdcall; external TangoDLL;
function LSX_GetSwitches(LSID: Integer; var Flags: Integer): Integer; stdcall; external TangoDLL;

function LSX_GetSerialNr(LSID: Integer; SerialNr: PChar; MaxLen: Integer): Integer; stdcall; external TangoDLL;
...
function LSX_SendStringPosCmd(LSID: Integer; Str, Ret: PChar; MaxLen: Integer; ReadLine: LongBool; TimeOut: Integer): Integer; stdcall; external TangoDLL;
function LSX_SetDigitalOutputs(LSID: Integer; Value: Integer): Integer; stdcall; external TangoDLL;
function LSX_SetWriteLogTextFN(LSID: Integer; AWriteLogText: LongBool; ALogFN: PChar): Integer; stdcall; external TangoDLL;
...
function LSX_GetVersionStrDet(LSID: Integer; VersDet: PChar; MaxLen: Integer): Integer; stdcall; external TangoDLL;
...
function LSX_GetVersionStrInfo(LSID: Integer; VersInfo: PChar; MaxLen: Integer): Integer; stdcall; external TangoDLL;
function LSX_GetStatusLimit(LSID: Integer; Limit: PChar; MaxLen: Integer): Integer; stdcall; external TangoDLL;
...
function LSX_GetStatusTVRO(LSID: Integer; Stat: PChar; MaxLen: Integer): Integer; stdcall; external TangoDLL;
